...
//(int id, String isbn, String title, String description, double price, int stock, String imgUrl)
            Book book1=new Book(
                    1,
            ...
            //for compositer primary key, change adding method ***
            //make to managed state first, and start add
            //book have composite primary key , so we make its relation table to be in managed state 1st
